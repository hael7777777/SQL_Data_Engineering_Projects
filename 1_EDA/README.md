...
- ✅ **Data Modeling:** Used **multi-table joins** across fact tables and dimension tables to extract insights
- ✅ **Analytics:** Applied **aggregations, filtering, and sorting** to find top skills by demand, salary, and overall value
- ✅ **Outcomes:** Delivered **actionable insights** on SQL/Python dominance, cloud trends, data salary patterns

You can review these if there is limited time:
[Top Demanded Skills Query](01_Top_Demanded_Skills.sql)
, [Top Paying Skills Query](02_Top_Paying_Skills.sql)
, [Optimal Skills Query](03_Optimal_Skills.sql)
